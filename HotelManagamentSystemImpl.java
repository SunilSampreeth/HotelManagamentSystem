...
public class HotelManagamentSystemImpl implements HotelManagamentSystem {
	...
	public void addFood() {
		...
		db.put(5, new Food(5,"Mutton biriyani  ", 150, 6));
		db.put(5, new Food(6,"Fish biriyani    ", 150, 6));
